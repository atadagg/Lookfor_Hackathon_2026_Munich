"""Tools for the WISMO (Where Is My Order) specialist.
            ...
            if orders:
                ...
                if order_id:
                    ...
                    if details_resp.success:
                        ...
                        # Normalise the keys expected by the WISMO graph.
                        normalised = {
...
async def track_shipment(tracking_number: str) -> ToolResponse:
    """Optional wrapper if callers want a tracking-first API.

    Today we return a deterministic payload; you can later wire this to a
    carrier API (AfterShip / EasyPost / etc).
    """
...
__all__ = ["get_order_status", "get_tracking_link", "track_shipment"]
